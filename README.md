...
I am seeking self-motivated students for remote positions as Intern Engineers and Research Assistants. Our research focuses on LLM foundation models, AI agents, industrial AI, and PHM. If you are interested in these areas, please feel free to contact me at jingxiao.liao[at]cityu.edu.hk.
...
- ``MSSP`` <b>JX Liao</b>, C He, J Li, J Sun, S Zhang∗, X Zhang∗, [Classifier-guided neural blind deconvolution: a physics-informed denoising module for bearing fault diagnosis under heavy noise, Mechanical Systems and Signal Processing](https://www.sciencedirect.com/science/article/pii/S0888327024006484)**(ESI High Cited Paper)**[![](https://img.shields.io/github/stars/asdvfghg/ClassBD?style=social&label=Code+Stars)](https://github.com/asdvfghg/ClassBD)
